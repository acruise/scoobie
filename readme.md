...
Check out [this end to end example](https://github.com/Jacoby6000/scoobie/blob/master/doobie-postgres/src/test/scala/scoobie/doobie/PostgresTest.scala#L74) for an idea of how to utilize insert/update/delete as well.
